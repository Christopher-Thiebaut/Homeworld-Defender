...
class Ground: GKEntity {
    ...
    init(spriteNode: SKSpriteNode, entityController: EntityController){
        ...
        let contactDamageComponent = ContactDamageComponent(spriteNode: spriteNode, contactDamage: 1000000, destroySelf: false, doNotHarm: [.environment], entityController: entityController)
