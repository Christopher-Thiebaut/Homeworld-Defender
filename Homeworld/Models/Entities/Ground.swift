...
class Ground: GKEntity {
    ...
    init(spriteNode: SKSpriteNode, entityController: EntityController){
        ...
        let contactDamageComponent = ContactDamageComponent(spriteNode: spriteNode, contactDamage: 1000, destroySelf: false, doNotHarm: [.environment, .human], entityController: entityController)
